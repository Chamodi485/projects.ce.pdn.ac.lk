...
layout: project_page
title: Smart IV
permalink: /3yp/e21/Smart-IV/
description: Automates standard gravity IVs with precise closed-loop stepper motor
  control. Features real-time drop counting, predictive volume estimation, and IoT
  connectivity for affordable, high-safety infusion monitoring.
has_children: false
