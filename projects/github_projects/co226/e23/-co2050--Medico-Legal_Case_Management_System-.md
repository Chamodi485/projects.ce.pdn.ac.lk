...
has_children: false
parent: E23 Database Projects (CO226)
...
A secure, cloud-native Medico-Legal Database Management System built with Python Flask and PostgreSQL (Supabase). Features strict Role-Based Access Control (RBAC), cryptographic password hashing, and automated forensic audit logging.